...
- **敏感信息过滤**：记忆系统隐私保护设置（详见 [八、记忆系统敏感信息过滤](#八记忆系统敏感信息过滤)）
- **技能交响乐与技能检索**：控制技能检索和技能编排（详见 [九、技能交响乐与技能检索配置](#九技能交响乐与技能检索配置)）

此外，面板中还包含 **免费搜索引擎配置**、**多Agent/Team 配置**、**A2UI**、**邮箱配置** 等区域，按需配置即可。
