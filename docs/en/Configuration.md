...
- **Shell Command Output Limits**: Head+tail truncation for large command output (see [12. Shell Command Output Limits](#11-shell-command-output-limits))
...
## 12. Shell Command Output Limits
